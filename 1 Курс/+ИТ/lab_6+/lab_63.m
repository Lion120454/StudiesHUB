function varargout = lab_63(varargin)
% lab_63 M-file for lab_63.fig
%      lab_63, by itself, creates a new lab_63 or raises the existing
%      singleton*.
%
%      H = lab_63 returns the handle to a new lab_63 or the handle to
%      the existing singleton*.
%
%      lab_63('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in lab_63.M with the given input arguments.
%
%      lab_63('Property','Value',...) creates a new lab_63 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before lab_63_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to lab_63_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help lab_63

% Last Modified by GUIDE v2.5 11-Jun-2022 11:26:37

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @lab_63_OpeningFcn, ...
                   'gui_OutputFcn',  @lab_63_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before lab_63 is made visible.
function lab_63_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to lab_63 (see VARARGIN)

% Choose default command line output for lab_63
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes lab_63 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = lab_63_OutputFcn(hObject, eventdata, handles) 
...
y2=(((r2.^2)-(x2.^2)).^0.5);
y22=-y2;
plot(x1,y1,x2,y2,x1,y12,x2,y22)
